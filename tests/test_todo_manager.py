...
def todo_test_data() -> List[TodoItem]:
    return [
        # T001: Has date and priority (Level 2), not complete
        TodoItem(
            todo_id="T001",
        ...
        # T002: Highest priority (Level 1), specific due date AND time
        TodoItem(
            todo_id="T002",
        ...
        # T003: Recurring daily (frequency=1), marked complete, no date/time
        TodoItem(
            todo_id="T003",
        ...
        # T004: Urgent (Level 1), past due date/time (assuming today is Oct 1st)
        TodoItem(
            todo_id="T004",
        ...
        # T005: Recurring monthly (frequency=30), high priority (Level 1)
        TodoItem(
            todo_id="T005",
        ...
        # T006: Completed item, past date, default priority (None)
        TodoItem(
            todo_id="T006",
        ...
        # T007: Minimalist item, all optionals are None/default
        TodoItem(
            todo_id="T007",
